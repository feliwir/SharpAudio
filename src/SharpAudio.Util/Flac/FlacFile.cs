...
namespace SharpAudio.Util.Flac
{
    ...
    public class FlacFile
    {
        ...
        private readonly AudioFormat _waveFormat;
        ...
        private AudioFormat CreateWaveFormat(FlacMetadataStreamInfo streamInfo)
        {
        ...
        protected virtual void Dispose(bool disposing)
        {
            lock (_bufferLock)
            {
                if (!_disposed)
                {
                    ...
                    if (_stream != null && !IsClosed() && _closeStream)
                        _stream.Dispose();
